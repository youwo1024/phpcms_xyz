             ...
             <div>
                 <div class="btns">
                     ...
                     <div id="nameTip" class="onShow">
                         <?php echo L('upload_up_to')?><font color="red"> <?php echo $file_upload_limit?></font> <?php echo L('attachments')?>,<?php echo L('largest')?> <font color="red"><?php echo sizecount($file_size_limit*1024)?></font>
                     </div>
                 </div>
                 <div class="bk3"></div>
